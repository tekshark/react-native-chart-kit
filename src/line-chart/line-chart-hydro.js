...
class LineChartHydro extends AbstractChart {
        ...
        <>
          <Defs>
            <LinearGradient id="path" x1="0" y1="0" x2="0" y2="1">
              <Stop offset="0" stopColor="#123DF1" stopOpacity="0.5" />
              <Stop offset="1" stopColor="#123DF1" stopOpacity="0.1" />
              <Stop offset="2" stopColor="#123DF1" stopOpacity="0" />
              <Stop offset="3" stopColor="#FFFFFF00" stopOpacity="1" />
            </LinearGradient>
          </Defs>
          <Path
            key={index}
